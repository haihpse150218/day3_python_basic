...
| Tên gọi                                                                             | Mô tả                                                                                                                                                                                                                                                                                                     | Ví dụ                                                 |
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| [list](https://docs.python.org/3/library/stdtypes.html#lists)                     | Là một [collection (tập hợp)](https://en.wikipedia.org/wiki/Immutable_object) các elements (yếu tố) không theo thứ tự và mutable (có thể thay đổi, ngược lại với [immutable - không thể thay đổi](https://www.youtube.com/watch?v=tw7ror9x32s)), các yếu tố có thể trùng lặp                                                                                                                                                                                    | `[2, 2, True, 0.65, "Hello!"]`                    |
...
| [set](https://docs.python.org/3/library/stdtypes.html#set-types-set-frozenset)    | Là một [collection]([http://raboninco.com/1KIkU](https://www.youtube.com/watch?v=2u_ZExcNBzA)) (tập hợp) các yếu tố không theo thứ tự và không có yếu tố trùng lặp                                                                                                                                                                                                                  | `{1, 2, 3}`                                                |
| [dictionary]([http://raboninco.com/1KIku](https://docs.python.org/3/tutorial/datastructures.html#dictionaries)) | Là một collection (tập hợp) các cặp [key/value]([http://raboninco.com/1KIlE](https://en.wikipedia.org/wiki/Attribute%E2%80%93value_pair)) (khóa/giá trị) không theo thứ tự (ví dụ: [associative array]([http://raboninco.com/1KIlZ](https://en.wikipedia.org/wiki/Associative_array))); trong [dictionary]([http://raboninco.com/1KIlj](https://www.youtube.com/watch?v=ZEZdys-fHDw)), mỗi key là duy nhất, mặc dù các yếu tố có thể trùng lặp | `{1: 2.5, 'username': 'haitac', 'is_student': True}` |
...
_Lưu ý: **bạn sẽ nen sử dụng `pipenv`** cho tất cả các nhiệm vụ mà bạn tham gia. Không phải là [NÊN SỬ DỤNG](https://innolution.com/resources/glossary/nice-to-have-features), mà là [**PHẢI SỬ DỤNG**](https://innolution.com/resources/glossary/must-have-features). Nếu không có tập Pipfile nào trong dự án Python của bạn => **-_-**!_
